    ...
    public static void main(String[] args) {
        ...
        CoapResource resource = new CoapResource("hello") {     // "/hello" resource
            ...
            public void handlePOST(CoapExchange exchange) {
                ...
                System.out.println("'" + getName() + "' called POST methods");
            ...
            public void handleGET(CoapExchange exchange) {
                ...
                System.out.println("'" + getName() + "' called GET methods");
                exchange.respond("Hello " + text.substring(text.indexOf("=") + 1));
            }
        };
        
        resource.add(new CoapResource("world") { // add "/hello/world" resource
            @Override
            public void handlePOST(CoapExchange exchange) {
                String text = exchange.getRequestText();
                System.out.println("'" + getName() + "' called POST methods");
